...
> __extensible__, _noun:_ The capability of being extended.

> __calculate__, _verb:_ To determine values or solutions by a mathematical process.

_A calculator in JavaScript that can be extended with additional functions and constants._
...
```javascript
    ...
    var expr = "1 + 2";
    var calc = new xc.calculator();
    var rslt = calc.calculate(expr); //3
